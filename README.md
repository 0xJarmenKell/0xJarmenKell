...
[![My Skills](https://skillicons.dev/icons?i=redux,react,ts,js,python,ruby,onrails,bash,powershell,jenkins,linux,git,docker,cs,html,css,scss,bootstrap,tailwindcss,webpack,vite,vscode,figma,nodejs,express,mongodb)](https://skillicons.dev)
